  ...
  return (
    <section className="max-w-xl mx-auto py-8 flex flex-col gap-7 items-center">
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        <Button variant="outline" className="font-semibold px-7 py-3" onClick={() => window.open(CALENDLY_URL, "_blank", "noopener,noreferrer")}>Book a 15-min walkthrough</Button>
        <Button variant="ghost" className="text-emerald px-7 py-3" onClick={() => window.open(TYPEFORM_URL, "_blank", "noopener,noreferrer")}>See how ESG-ready your company is</Button>
        <Button className="bg-emerald text-white px-7 py-3" onClick={() => window.open(EMAIL_TEMPLATE, "_blank")}>Get a free ESG audit template</Button>
      </div>
    </section>
  );
}
