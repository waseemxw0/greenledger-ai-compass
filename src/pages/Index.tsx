      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 sm:mb-8 gap-4 relative">
        <div className="w-full md:w-auto">
          <div className="animate-in fade-in duration-500">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight bg-gradient-to-r from-primary/90 to-primary bg-clip-text text-transparent">
              ESG Dashboard
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            <div className="glass-card rounded-lg p-4 sm:p-6 interactive-card shadow-soft">
              <div className="flex items-center mb-4">
                <div className="bg-gradient-to-br from-primary/20 to-primary/5 rounded-full p-2 sm:p-3 mr-3 sm:mr-4 shadow-inner">
              ...
              <div className="mt-4 h-16 sm:h-24 chart-container">
                <div className="bg-gradient-to-t from-muted to-transparent h-full w-full rounded-md flex items-end">
